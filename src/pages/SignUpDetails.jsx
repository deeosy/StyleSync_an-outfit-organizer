  ...
  return (
    <div className="mx-4 sm:mx-10 py-[30px]">
      <div className="flex items-center justify-between w-full">
        ...
        <p className="text-center sm:text-[20px] font-bold ">
          Tell us who you are
        </p>
        <div className=""></div>
      </div>
      ...
      <p className="text-[12px] text-gray-500 mb-[25px]">
        We are creating a personalised experience for you based on the
        information you provide
      </p>
      <form
        onSubmit={handleSubmit}
        className="flex flex-col gap-[16px] text-gray-400"
      >
        {/* Gender Selection */}
