...
export default function PasswordInputField({userPassword, handleChange}) {
  ...
  return (
    <div className={`flex flex-col ${passwordLength>0 && passwordLength<8? 'gap-[8px]':'gap-[12px]'}`}>
      <div className={`flex justify-between py-[12px] px-[16px] border ${passwordLength>0 && passwordLength<8? 'border-[#ED4F9D]':'border-gray-400'} rounded-[5px] h-auto w-full`}>
        <div className="flex gap-[12px] ">
          ...
          <input
            ...
            className="text-[14px] outline-none text-gray-900 font-medium placeholder:text-gray-400 "
        ...
        {/* Show/Hide Password Button, Also added aria-label for screen readers */}
      ...
      {passwordLength>0 && passwordLength<8? <PasswordError />
